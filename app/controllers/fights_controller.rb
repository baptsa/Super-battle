...
class FightsController < ApplicationController
  ...
  def create
    ...
    @fight = Fight.new(
      ...
      follower_score_challenger: @challenger_follower_score,
      media_score_challenger: @challenger_media_score,
      engagement_score_challenger: @challenger_engagement_score,
      final_score_challenger: @challenger_final_score,
      opponent_id: @opponent.id,
      follower_score_opponent: @opponent_follower_score,
      media_score_opponent: @opponent_media_score,
      engagement_score_opponent: @opponent_engagement_score,
      final_score_opponent: @opponent_final_score
    )
